...
namespace TariffCompare.Standard.Test
{
    ...
    public class HelperTests
    {
        ...
        {   // simple method with lots potential combionations and edge cases!
        ...
        {
            CONSTANTS.FUELTYPE type = (CONSTANTS.FUELTYPE) Enum.Parse(typeof(CONSTANTS.FUELTYPE), fuelType, true); // will throw if not a valid type so test will fail
